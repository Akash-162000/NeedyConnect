...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2020 at 08:36 PM
...
(2, 'TCS', 'Mohan Shah', 'Navarangpura1', 'Ahmedabad', 'mohan@gmail.com', 9898989898, 'Software', 'Confirm', 'mohan', 'mohan', 'Who is Your Favourite Person?', 'sachin'),
(3, 'Wipro ', 'Sunil Pandya', 'Baroda', 'Baroda', 'sunil@wipro.com', 8989898989, 'Hardware', 'Confirm', 'sunil', 'sunil', '', ''),
(6, 'BAJAJ', 'Saurav Bajaj', 'Mumbai', 'Mumbai', 'saurav@gmail.com', 8532145678, 'Software and Hardware', 'confirm', 'saurav', 'saurav', 'What is Your Pet Name?', 'ramu'),
(8, 'Godreg', 'Rajesh', 'Mumbai', 'Mumbai', 'rajesh@gmail.com', 9686185652, 'Hardware', 'Confirm', 'rajesh', 'rajesh', 'Who is Your Favourite Person?', 'Shahrukh Khan');
...
(3, 'Akash', 'pemmanahalli', 'dabaspete', 'akashn162000@gmail.com', 9380135656, 'Btech', 'Male', '2000-06-01', '', 'Confirm', 'Akash', 'akash', 'What is Your Pet Name?', 'ramu'),
(4, 'Diwakar', 'Bidar', 'Bidar', 'diwakar@gmail.com', 8457214562, 'M.C.A', 'Male', '1999-11-05', '', 'confirm', 'diwakar', 'diwakar', 'Who is Your Favourite Person?', 'sachin'),
(5, 'Krishnamurthy', 'Mandya', 'Mandya', 'krishnamurthy@gmail.com', 9457841245, 'M Tech', 'Male', '1998-07-08', '', 'Confirm', 'krishna', 'krishna', 'What is the Name of Your First School?', 'JNV');
...
(7, 'BAJAJ', 'Software Engineer Trainee', 3, 'B Tech', 'Freshers required '),
(8, 'TCS', 'Software Engineer', 2, 'B Tech', 'software engineers required');
...
(3, 'New vacancies at TCS', '2020-11-30');
...
(3, 'TCS', 'Software Engineer', 3, 'B Tech', 'software engineers required', '2020-11-30', '00:00:10');
...
--
ALTER TABLE `jobseeker_reg`
  MODIFY `JobSeekId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
